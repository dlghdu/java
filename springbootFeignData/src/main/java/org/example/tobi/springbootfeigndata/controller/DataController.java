package org.example.tobi.springbootfeigndata.controller;

import jakarta.annotation.PostConstruct;
import org.example.tobi.springbootfeigndata.dto.DataRequest;
import org.example.tobi.springbootfeigndata.dto.DataResponse;
...
public class DataController {
    ...
    @PutMapping("/{id}")
    public DataResponse updateData(@PathVariable Long id, @RequestBody DataRequest dataRequest) {
        DataResponse dataResponse = dataStore.get(id);
        if (dataResponse == null) {
            throw new RuntimeException("Data not found with ID : " + id);
        }
