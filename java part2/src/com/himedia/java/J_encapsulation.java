...
// * 캡슐화(Encapsulation)
// 객체 지향 프로그램의 기본 원칙 중 하나로, 데이터를 숨기고 그 데이터를 조작하는 메서드만
// 외부에 노출하여 객체 내부의 상태를 보호하는 개념이다.
...
public class J_encapsulation {
    ...
    //  Setter메서드 : 외부에서 필드에 접근할 수 있도록 허용.
    public void setName(String name) {
        this.name = name;
    }

    // 유효성 검사를 추가하여 올바른 값만 올 수 있도록함.
    ...
    // getter메서드 : 외부에서 필드에 값을 설정할 수 있도록 허용.
