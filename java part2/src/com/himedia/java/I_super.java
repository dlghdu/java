...
// 멤버변수와 지역변수 이름이 같을 때 this를 붙여 구별했듯이 상속받은 멤버와 자신의 멤버와 이름이 같을 때는
// super라는 키워드를 붙여서 구별할 수 있다.
...
// 그래서 this와 super는 static메서는 사용할 수 없고
// new를 이용해서 생성한 인스턴스에서만 사용할 수 있다.
