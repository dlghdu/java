...
public class D_static_class {
    ...
    // 즉 이 클래스는 바깥 클래스의 인스턴스에 속하지 않으며, 바깥 클래스의 인스턴스가 없어도 사용될 수 있다.
    ...
    // -> 비정적 중첩 클래스의 인스턴슬르 생성하려면 먼저 바깥 클래스의 인스턴스를 생성해야 한다.
    ...
    // 비정적
    // 바깥 클래스와 밀접하게 연결되어 있으며, 바깥 클래스의 인스턴스 멤버에 접근해야 할 때 사용.
