...
// - 객체를 생성할 때 인수를 전달받아 필드를 초기화한느 생성자이다.
...
// * 생성자의 역할과 이점
// 1. 객체 초기화 : 생성자는 객체가 생성될 때 필요한 초기값을 성정하는데 사용된다.
// 2. 코드의 가독성 : 다양한 형태의 생성자를 제공함으로서, 객체를 직관적이고 간결하게 생성할 수 있다.
...
public class F_construtor {
    public static void main(String[] args) {
        ...
        F_person2 p2 = new F_person2("Jhon", 13);
        p2.display();

        F_person3 p3 = new F_person3();
        p3.display();

        p3 = new F_person3("jhon");
        p3.display();

        p3 = new F_person3("jhon", 13);
        p3.display();
        ...
        // - 생성자의 이름으로 클래스이름 대신 this를 사용한다. 왜? 자바 만든 사람이 그렇게 하랬다.
