...
// List 인터페이스를 구현하는 대표적인 클래스에는 ArrayList, LinkedList, Vector(잘 안쓴다한다한다) 등이 있다.
...
// - stack은 후입후출 (Last in First out) 구조를 가지며, 요소를 스택에 추가하고 제거하는데 사용된다.
...
public class A_collections_list {
    ...
    // 2. LinkedList (내부적으로 차이가 있을 뿐 별반 다를건 없다.)
    ...
    // - 주요 메서드 : push() 요소삽입, pop() 요소제거, peek() 맨 위의 요소를 확인, empty() 스택이
    public static void exam3() {
        ...
        while (iterator.hasNext()) {
            ...
            System.out.println("Stack elements : " + elememt);
        }
        ...
        while (!stack.isEmpty()) {
            ...
            System.out.println("{Popend elemets : " + element);
        }
