...
// 반면에 notify()는 대기 중인 스레드 중 하나만 깨우기 떄문에 기아 현상이 발생할 가능성이 크다.
...
class WorkerThread extends Thread {
    ...
    public WorkerThread(SharedResource sharedResource, String threaName) {
    ...
    public void run() {
        while (true) {
            sharedResource.waitForResource(threaName);
            try {
