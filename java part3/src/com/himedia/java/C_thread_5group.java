...
// * 스레드 그룹
// 스레드 그룹은 서로 연관된 스레드를 그룹으로 다루기 위한 것으모,
...
public class C_thread_5group {

    public static void main(String[] args) {
        ThreadGroup main = Thread.currentThread().getThreadGroup();
        ThreadGroup group1 = new ThreadGroup(main, "Group1");
        ThreadGroup group2 = new ThreadGroup(main, "Group2");
        ...
        new Thread(group1, runnable1).start();
        new Thread(subGroup1, runnable1).start();
        new Thread(group2, runnable1).start();
