...
import org.example.tobi.catalogservice.domain.BookAlreadyExistException;
import org.example.tobi.catalogservice.domain.BookNotFoundException;
...
public class BookControllerAdvice {
    ...
    public String bookAlreadyExistsHandler(BookAlreadyExistException ex) {
        return ex.getMessage();
    }
