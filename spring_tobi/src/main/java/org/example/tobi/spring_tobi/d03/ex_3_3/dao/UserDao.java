package org.example.tobi.spring_tobi.d03.ex_3_3.dao;

import org.example.tobi.spring_tobi.d03.ex_3_3.domain.User;
...
//            ps = makeStatement(connection);
            ...
            // 2. 전략패턴
            // 한계점
            // 전략패턴은 필요에 따라 컨텍스트는 그대로 유지되면서 전략을 바꿔 쓸 수 있다.
